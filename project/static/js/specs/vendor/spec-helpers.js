...
var SpecHelpers = {
    ...
    Events: {
        ...
        simulateMouseClick: function($el, x, y){
            return this.simulateMouseEvent($el, 'click', x, y);
        },

        simulateMouseDblClick: function($el, x, y){
            return this.simulateMouseEvent($el, 'dblclick', x, y);
        },
